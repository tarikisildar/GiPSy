...
%token BI_SHOWONMAP BI_SEARCHLOCATION BI_GETROADSPEED BI_GETLOCATION BI_SHOWTARGET GRAPH_TYPE ROAD_TYPE USER_TYPE GPSLOC_TYPE CROAD_TYPE
...
builtin_type:		GRAPH_TYPE | ROAD_TYPE | USER_TYPE | GPSLOC_TYPE | CROAD_TYPE
...
comprasion_op:		SMALLER | GREATER | GEQUAL | LEQUAL | EQUALITY_CHECK | NOT_EQUAL
